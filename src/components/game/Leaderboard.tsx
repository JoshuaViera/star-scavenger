            ...
            <table className="w-full">
              <thead className="bg-gray-800 text-gray-300 text-sm">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center">Bosses</th>
              ...
              <tbody className="text-gray-200">
                {entries.map((entry, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">{entry.level_reached}</td>
                    <td className="px-4 py-3 text-center">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        entry.difficulty === 'easy' ? 'bg-green-900 text-green-300' :
                        entry.difficulty === 'medium' ? 'bg-yellow-900 text-yellow-300' :
                        'bg-red-900 text-red-300'
                      }`}>
                        {entry.difficulty}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-center">{entry.bosses_defeated}</td>
